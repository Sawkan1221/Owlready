...
import ontologyTemplateMethod as OntologyMaster

ontologyObject = OntologyMaster.OntologyTemplateMethod("file://fma.owl", "http://purl.org/sig/ont/fma/")
ontologyObject.printAll()
#print(ontologyObject.getOne('45723'))
